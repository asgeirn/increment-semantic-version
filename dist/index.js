...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const current = core.getInput('current-version');
            const fragment = core.getInput('version-fragment');
            core.debug(`Bumping ${current} with ${fragment} ...`); // debug is only output if you set the secret `ACTIONS_STEP_DEBUG` to true
            core.setOutput('next-version', (0, version_1.updateVersion)({ current, fragment }));
        }
        catch (error) {
...
const format = (major, minor, patch, prerelease, build) => {
...
const updateVersion = ({ current, fragment }) => {
